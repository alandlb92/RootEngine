...
VertexShaderOutput SimpleSkinnedVertexShader(AppData IN)
{
    ...
    //{
    //    if(IN.boneData.weights[i] > 0)
    //    {
            
    //        int boneId = IN.boneData.boneId[i];
    //        float weight = IN.boneData.weights[i];            
    //        float4x4 boneTransformMatrixWeight = animMatrix[boneId] * weight;
    //        boneTransform += boneTransformMatrixWeight;
    //    }
    //}
