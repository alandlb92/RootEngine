...
namespace Faia
{
    namespace Root
    {
        ...
        class RAnimationComponent : public RComponent
        {
        public:
        ...
        private:
            ...
            RVector3D GetVectorKeyAtCurrentTick(std::vector<RAnimationVectorKey>& vectorKeyList);
            RQuaternion GetQuatKeyAtCurrentTime(std::vector<RAnimationQuatKey>& quatKeyList);
