...
namespace Faia
{
    namespace Root
    {
        struct RMatrix4x4
        {
            ...
            static RMatrix4x4 CreateTransitionMatrix(RVector3D& position)
            {
            ...
            static RMatrix4x4 CreateRotationMatrixFromQuaternion(RQuaternion& quaternion)
            {
                RMatrix4x4 m;
            ...
            static RMatrix4x4 CreateScaleMatrix(RVector3D& scale)
            {
            ...
            static RMatrix4x4 CreateTransformationMatrix(RVector3D& position, RQuaternion& quatRotation, RVector3D& scale) {
