...
namespace Faia
{
    namespace Root
    {
        void RMesh_DX11::SetVertices(vector<RVector3D> verctices)
        {
            ...
            HRESULT hr = NULL;//GetDevice()->CreateBuffer(&vertexBufferDesc, &resourceData, mVertexBuffer.GetAddressOf());
        ...
        void RMesh_DX11::SetIndices(vector<uint16_t> indices)
        {
            ...
            ID3D11Device* device = nullptr;//GetDevice();
        ...
        void RMesh_DX11::SetUV(vector<RVector2D> uv)
        {
            ...
            HRESULT hr = NULL;// GetDevice()->CreateBuffer(&uvBufferDesc, &resourceData, mUvBuffer.GetAddressOf());
            if (FAILED(hr))
            {
        ...
        void RMesh_DX11::SetNormals(vector<RVector3D> normals)
        {
            ...
            HRESULT hr = NULL;//GetDevice()->CreateBuffer(&normalBufferDesc, &resourceData, mNormalBuffer.GetAddressOf());
