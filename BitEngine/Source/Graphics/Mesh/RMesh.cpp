...
namespace Faia
{
    namespace Root
    {
        void RMesh::SetVertices(vector<Vector3D> verctices)
        {
            mVertices = verctices;
            ...
            vertexBufferDesc.ByteWidth = sizeof(Vector3D) * mVertices.size();
        ...
        void RMesh::SetUV(vector<Vector2D> uv)
        {
            mUv = uv;
            // Create and initialize the index buffer.
            ...
            uvBufferDesc.ByteWidth = sizeof(Vector2D) * mUv.size();
        ...
        void RMesh::SetNormals(vector<Vector3D> normals)
        {
            mNormals = normals;
            ...
            normalBufferDesc.ByteWidth = sizeof(Vector3D) * mNormals.size();
